...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    */
    ...
    GPIO_InitStruct.Pin = GPIO_PIN_5|STMOD_ADC_Pin|GPIO_PIN_3|GPIO_PIN_1;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA1     ------> ADC1_IN6
    */
    HAL_GPIO_DeInit(GPIOC, ARD_A0_Pin|GPIO_PIN_0|ARD_A2_Pin);

    HAL_GPIO_DeInit(GPIOA, GPIO_PIN_5|STMOD_ADC_Pin|GPIO_PIN_3|GPIO_PIN_1);
...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  */
    ...
    */
    ...
    GPIO_InitStruct.Pin = UART1_RX_Pin|GPIO_PIN_11|GPIO_PIN_12;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF7_USART1;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOG, UART1_RX_Pin|GPIO_PIN_11|GPIO_PIN_12);
